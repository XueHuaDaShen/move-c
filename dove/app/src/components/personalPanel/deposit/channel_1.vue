<template>
  <div class="deposit user-common">
    <div class="deposit-inner">
      <div class="user-card">
        <div class="row title insert-to-bottom-line">{{$t('message.must_use')}}</div>
        <div class="row mt-30">
      ...
      <div class="user-card mt-30">
        <div class="row title insert-to-bottom-line">{{$t('message.transfer_account')}}</div>
        <div class="row mt-30">
      ...
      <div class="fill-amount">
        ...
        <div class="insert-to-bottom-line mt-10" style="font-size:4.27vw;text-align:left;">{{$t('message.fill_in_amount')}}</div>
        ...
        <div class="mt-10 input-outer">
          <el-select style="width:100%;height:100%;" v-model="form.packageid.val" :placeholder="$t('message.select_the_promotion')"
