  ...
  <div class="rechargeLot-wrap el-custom">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="teamReportListData" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column align="center" label="Bet Amount" prop="bet" :formatter="formatMoney">
        </el-table-column>
        ...
        <el-table-column align="center" label="Game Win/Loss" prop="bet_profit" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" label="Deposit" prop="deposit" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" label="Withdrawal" prop="withdrawal" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" label="Gift" prop="gift" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" label="Total Profit">
          <template slot-scope="scope">
            {{formatMoney('', '', (scope.row.bet_profit - scope.row.gift))}}
            <!-- {{scope.row.bet_profit - scope.row.gift}} -->
          </template>
        </el-table-column>
      </el-table>
      <div class="fenye">
  ...
  methods: {
    getSummaries(param) {
      ...
      columns.forEach((column, index) => {
        ...
        if (index === 9) {
          values = data.map(item => Number(item.bet_profit-item.gift));
        }
