      ...
      >
        <el-table-column align="center" label="User Name" width="126">
          <template slot-scope="scope">
            <i class="el-icon-s-flag" style="color:#F56C6C;margin-right:5px;" v-if="isNewUser(scope.row)"></i>
            <el-button
              type="text"
              size="small"
        ...
        <el-table-column align="center" prop="firstname" width="110" label="First Name" :formatter="formatIsExist">
        </el-table-column>
        <el-table-column align="center" prop="lastname" width="110" label="Last Name" :formatter="formatIsExist">
        </el-table-column>
        <el-table-column align="center" label="Balance" prop="cash" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" label="Phone Number" prop="phone" :formatter="formatIsExist">
        </el-table-column>
        <el-table-column align="center" label="Line ID" prop="lineid" :formatter="formatIsExist">
        </el-table-column>
        <el-table-column align="center" label="Email" prop="email" :formatter="formatIsExist">
        </el-table-column>
...
export default {
  ...
  methods: {
    ...
    isNewUser(row) {
      ...
      let regTime = new Date(row.create_at);
      let isNewUser = (Math.floor((currTime - regTime)/1000/60/60) < 24);
      return isNewUser
    },
    searchTypeChange() {
      this.username = "";
    ...
    formatIsExist(row, column, cellValue) {
      if (cellValue) {
        return cellValue;
      }
      return "--";
