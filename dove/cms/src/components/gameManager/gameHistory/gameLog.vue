  ...
  <div class="el-custom gameLog">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="dataList" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column align="center" label="User Name" prop="playerid" width="126">
        </el-table-column>
        <el-table-column align="center" label="Provider" prop="provider">
        </el-table-column>
        <el-table-column align="center" label="Game" prop="third_game_name" width="150">
        </el-table-column>
        <el-table-column align="center" label="Host" prop="third_hostid">
        </el-table-column>
        <el-table-column align="center" label="Bet" prop="bet_amount" :formatter="formatMoney">
        </el-table-column>
        <!-- <el-table-column align="center" label="Jackpot Contribute" prop="jackpot_contribution" :formatter="formatMoney">
        </el-table-column> -->
        <el-table-column align="center" label="Reward" prop="payout" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" label="Win/Loss" prop="win_lose" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" label="Game Time" prop="create_at" :formatter="formatTime">
        </el-table-column>
      </el-table>
      <div class="fenye">
...
export default {
  ...
  created() {
    ...
    let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'gameLog');
  ...
  methods: {
    ...
    formatTime(row, column, cellValue) {
      ...
      if (cellValue) {
        ...
        return moment(vm.searchTime[0]).format("DD-MM-YYYY HH:mm:ss") + ' To ' + moment(vm.searchTime[1]).format("DD-MM-YYYY HH:mm:ss");
      }else{
        return '--';
      }
    },
