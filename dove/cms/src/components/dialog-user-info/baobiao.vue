  ...
  <div>
    <div style="padding: 12px 20px 0px;">
      <div class="baobiao-search-term">
        <div class="baobiao-search-time">
          <el-date-picker format="dd-MM-yyyy HH:mm:ss" v-model="searchTime" type="datetimerange" align="right" unlink-panels range-separator="-"
            start-placeholder="begin" end-placeholder="end" :picker-options="pickerOptions1">
          </el-date-picker>
        </div>
      ...
      <div class="baobiao-content">
        <el-table :data="tableData" show-summary :summary-method="getSummaries" v-loading="dataLoading" empty-text="No data"
