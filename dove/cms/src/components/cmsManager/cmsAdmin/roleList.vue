<template>
  <div class="role-wrap el-custom">
    ...
    <div class="content-middle">
      <div class="search-wrap">
        <div class="search-inner-wrap">
          <el-button type="success" @click="createRole" size="medium" class="edit">Create Group</el-button>
        </div>
      </div>
    </div>
      ...
      <el-table :data="activityLogListData" header-row-class-name="table-header" align="left" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column label="Action">
          <template slot-scope="scope">
            ...
            <el-button @click="updateMenu(scope.row)" class="small edit">Authorization</el-button>
            <el-button @click="membersView(scope.row)" class="small no">Members</el-button>
          </template>
        </el-table-column>
      </el-table>
      <div class="fenye">
    ...
    <el-dialog title="Create Group" :visible.sync="dialogFormVisible" @close="resetForm('form')">
      <div class="body-middle">
        <div class="form">
          ...
          <div class="form-row form-cen">
            <h2 class="form-cen-title">Previllage<span class="exp-after">:</span></h2>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="createRoleFn('form')" class="yes" :loading="createLoading">Confirm</el-button>
        <!-- <el-button v-if="!isCreate" type="primary" @click="editRoleFn('form')" class="yes">Confirm</el-button> -->
      </div>
    </el-dialog>
    <el-dialog title="Authorization" :visible.sync="dialogFormVisible2" @close="resetForm('updateMenuForm')">
      <div class="body-middle">
        <div class="form">
          <div class="form-row form-top">
            <span class="exp">Group</span>
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="resetForm('updateMenuForm')" class="no">Cancel</el-button>
        <el-button type="primary" @click="updateUserMenu('updateMenuForm')" class="yes" :loading="updateLoading">Confirm</el-button>
      </div>
    </el-dialog>
    <el-dialog title="Members" :visible.sync="dialogFormVisible3">
      <div class="body-middle">
        <div class="form">
          <el-table align="left" :data="membersData" empty-text="Please add members.">
            <el-table-column property="loginname" label="User Name"></el-table-column>
            <el-table-column property="is_forbid" label="Status" width="200">
              <template slot-scope="scope">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button @click="dialogFormVisible3 = false" class="no">OK</el-button>
        <!-- <el-button type="primary" @click="dialogFormVisible3 = false" class="yes">Confirm</el-button> -->
      </div>
    </el-dialog>
  </div>
</template>
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'roleList');
        ...
        request.http(
          ...
          (success) => {
            ...
            if (code === 200) {
              ...
              vm.$message({
                message: 'No privilege assigned to role',
                type: 'warning',
                duration: vm.duration,
                center: true
              })
