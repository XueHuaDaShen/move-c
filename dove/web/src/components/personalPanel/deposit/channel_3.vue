<template>
  <div class="deposit_channel_3" v-loading.fullscreen="loading" element-loading-background="rgba(0, 0, 0, 0.5)">
    <div class="deposit_channel_3-inner">
      <div class="fill-amount">
        <div class="amount-row">
          <div class="flex-col">
            <div class="mt-20">{{$t('message.amount')}} <span class="red" v-if="form.amount.require">*[100 - 500000]</span></div>
