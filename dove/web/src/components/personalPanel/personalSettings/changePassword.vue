  ...
  <div class="changePassword">
    <div class="changePassword-inner">
      ...
      <div class="fill-amount">
        <!-- <div class="user-tab-line mt-30">{{$t('message.safety_management')}}</div> -->
        <div class="user-tab-line mt-30">{{$t('message.change_password')}}</div>
    ...
    methods: {
      ...
      changePw(data) {
        ...
        vm.$http.post('/user/random', {
          loginname: localStorage.getItem('dove-web-loginname')
        }, {
          emulateJSON: true
        }).then(res => {
          let data = res.data;
