<template>
  <div class="common team-widhdraw-wrap">
    <div class="container">
      <div class="tab">
        ...
        <router-link class="tab-item selected" :to="{name:'teamWithdraw'}">
          <div class="item-inner">
            ...
            <table class="record-table mt-60">
              ...
              <tbody>
                <tr v-if="!noResult" v-for="(item,index) in list" :key="index">
                  ...
                  <td>
                    <div class="cell">{{item.cash_withdrawed | formatCash}}</div>
                  </td>
                  <td>
...
<script>
  ...
  export default {
    ...
    computed: {},
    created() {
      sessionStorage.setItem("th_tag_url", "teamWithdraw");
    },
    mounted() {
      this.setTimeToday();
      this.handleSearch();
    ...
    methods: {
      ...
      onSubmit() {
        ...
        // };
        vm.loading = true;
        let url = '/agency/team/withdraw/list' + '?page_size=' + vm.pageSize + '&page_num=' + vm.pageIndex +
      ...
      formatStatus(v) {
        ...
        if (v) {
          switch (v) {
            case 1:
              return this.$t('message.shen_qing_ti_xian');
            case 2:
              return this.$t('message.ti_xian_cheng_gong');
            case 7:
              return this.$t('message.ti_xian_shi_bai');
            default:
              return v;
          }
        }
