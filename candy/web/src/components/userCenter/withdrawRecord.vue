<template>
  <div class="common withdraw-wrap">
    <div class="container">
      <div class="tab">
        ...
        <router-link class="tab-item selected" :to="{name:'withdrawRecord'}">
          <div class="item-inner">
            ...
            <table class="record-table mt-60">
              <thead>
                <tr>
                  ...
                  <th>
                    <div class="cell">{{$t('message.dao_zhang_jin_e')}}</div>
                  </th>
                  <th>
...
<script>
  ...
  export default {
    ...
    computed: {},
    created() {
      sessionStorage.setItem("th_tag_url", "withdrawRecord");
    ...
    methods: {
      ...
      onSubmit() {
        ...
        vm.loading = true;
        let url = '/user/trade/withdraw/list' + '?page_size=' + vm.pageSize + '&page_num=' + vm.pageIndex +
