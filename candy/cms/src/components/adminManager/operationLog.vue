  ...
  <div class="el-custom">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="logListData" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column align="center" label="Category" width="200" prop="op">
        </el-table-column>
        <el-table-column align="center" label="UA">
          <template slot-scope="scope">
        ...
        <el-table-column align="center" prop="create_at" :formatter="formatTime" label="Create At">
        </el-table-column>
      </el-table>
      <div class="fenye">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'operationLog');
