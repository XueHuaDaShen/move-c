  ...
  <div class="rechargeLot-wrap el-custom">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="teamReportListData" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <!-- <el-table-column align="center" prop="dividend_team" label="Share" :formatter="formatMoney">
        </el-table-column> -->
        <!-- <el-table-column align="center" prop="payreward_team" label="Paid" :formatter="formatMoney">
        </el-table-column> -->
        <el-table-column align="center" prop="refund_team" label="commission" :formatter="formatMoney">
        </el-table-column>
