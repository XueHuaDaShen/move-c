<template>
  <div class="rechargeLot-wrap el-custom">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="financialPersonalListData" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column align="center" prop="rechargechild" label="Recharge" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="withdrawalchild" label="Withdrawal" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="creditchild" label="Credit" :formatter="formatMoney">
        </el-table-column>
      </el-table>
      <div class="fenye">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'financialPersonal');
    ...
    methods: {
      ...
      getfinancialPersonalList() {
        ...
        request.http(
          ...
          success => {
            vm.loading = false;
            // console.log("financialPersonalList--------", success);
            let code = success.returncode;
            if (code === 200) {
              vm.financialPersonalListData = success.data;
