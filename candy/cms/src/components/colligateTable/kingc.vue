        ...
        <div class="wrap-container">
          <div class="container-body">
            ...
            <div class="body-row">
              ...
              <div class="row-item visibility-hidden">
                <span class="inline-flx">
                  <i class="icon-tip-small"></i>
                  Total Credit
                </span>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'kingcReport');
    ...
    methods: {
      ...
      getkingcList() {
        ...
        request.http(
          ...
          success => {
            // console.log("kingcList--------", success);
            let code = success.returncode;
            if (code === 200) {
              /* vm.kingcListData = success.data;
