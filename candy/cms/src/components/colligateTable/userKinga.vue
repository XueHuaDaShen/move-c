  ...
  <div class="rechargeLot-wrap el-custom">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="teamReportListData" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column align="center" prop="bid_total_team" label="Bet" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="bid_valid_team" label="Vaild Bet" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="reward_team" label="A-share PCT" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="dividend" label="Share" :formatter="formatMoney">
        </el-table-column>
        <!-- <el-table-column align="center" prop="dividend_team" label="Team Share" :formatter="formatMoney">
        </el-table-column> -->
        <el-table-column align="center" prop="payreward" label="Paid" :formatter="formatMoney">
        </el-table-column>
        <!-- <el-table-column align="center" prop="payreward_team" label="Team Paid" :formatter="formatMoney">
        </el-table-column> -->
        <el-table-column align="center" prop="bid_profit" label="Win/loss" :formatter="formatMoney">
        </el-table-column>
        <!-- <el-table-column align="center" prop="bid_profit_team" label="Team Win/loss" :formatter="formatMoney">
        </el-table-column> -->
        <el-table-column align="center" prop="kingprofit_team" label="Platform Profit" :formatter="formatMoney">
        </el-table-column>
      </el-table>
      <div class="fenye">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'userKinga');
