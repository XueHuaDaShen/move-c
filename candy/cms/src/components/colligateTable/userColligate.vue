<template>
  <div class="rechargeLot-wrap el-custom">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="userReportListData" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column align="center" prop="bid_total" label="Bet" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="bid_valid" label="Vaild Bet" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="reward" label="A-share PCT" :formatter="formatMoney">
        </el-table-column>
        ...
        <el-table-column align="center" prop="refund" label="commission" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="bid_profit" label="Win/loss" :formatter="formatMoney">
        </el-table-column>
        <el-table-column align="center" prop="kingprofit" label="Platform Profit" :formatter="formatMoney">
        </el-table-column>
      </el-table>
      <div class="fenye">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'userReport');
    ...
    methods: {
      ...
      getuserReportList() {
        ...
        request.http(
          ...
          success => {
            vm.loading = false;
            // console.log("userReportList--------", success);
            let code = success.returncode;
            if (code === 200) {
              vm.userReportListData = success.data;
