          ...
          <div class="container-body">
            ...
            <div class="body-row">
              <div class="row-item">
                ...
                <span class="warning">{{formatMoney(data.recharge)}}</span>
              </div>
              <div class="row-item">
                <span class="inline-flx">
                  <i class="icon-tip-small"></i>
              ...
              <div class="row-item">
                ...
                <span class="warning">{{formatMoney2(data.rebate,data.rebate_ex)}}</span>
              </div>
            </div>
            <div class="body-row">
              <div class="row-item">
              ...
              <div class="row-item">
                ...
                <span class="warning">{{formatMoney(data.game_rebate)}}</span>
              </div>
            </div>
            <div class="body-row">
              <div class="row-item">
                ...
                <span class="warning">{{formatMoneyMount(data.recharge,data.withdrawal)}}</span>
              </div>
              <div class="row-item">
                <span class="inline-flx">
                  <i class="icon-tip-small"></i>
                ...
                <span class="warning">{{formatMoney(data.undo)}}</span>
              </div>
              <div class="row-item">
                <span class="inline-flx">
                  <i class="icon-tip-small"></i>
            ...
            <div class="body-row">
              <div class="row-item">
                ...
                <span class="warning">{{formatMoney(data.gift)}}</span>
              </div>
              <div class="row-item">
                <span class="inline-flx">
                  <i class="icon-tip-small"></i>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'platformColligate');
