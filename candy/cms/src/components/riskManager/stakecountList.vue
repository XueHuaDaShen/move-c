    ...
    <div class="content-header">
      ...
      <div class="search-wrap">
        ...
        <div class="search-content">
          ...
          <!-- <div class="search-inner-wrap">
            <label>Period：</label>
            <el-date-picker format="dd-MM-yyyy HH:mm:ss" v-model="searchTime" type="datetimerange" align="right" unlink-panels range-separator="-" start-placeholder="begin"
              end-placeholder="end" :picker-options="pickerOptions">
            </el-date-picker>
          </div> -->
          <!-- <div class="search-inner-wrap">
            <label>打码量：</label>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'stakecountList');
