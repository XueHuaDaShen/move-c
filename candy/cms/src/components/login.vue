    ...
    <el-col :span="6" class="login" v-loading="loading" :style="login">
      <div class="grid-content bg-purple">
        ...
        <el-form :model="loginForm" ref="loginForm" class="demo-dynamic" style="position:relative;">
          ...
          <el-form-item>
            <el-button @click="submitForm('loginForm')" class="login-btn" plain>Login</el-button>
          </el-form-item>
      ...
      getMenuList() {
        ...
        request.http(
          ...
          success => {
            ...
            if (code === 200) {
              // console.log(success)
              localStorage.setItem("cms-user-menu", JSON.stringify(success.data));
              localStorage.setItem("candy-cms-isLogin", 'true');
              vm.$router.push({
                path: "/home"
              });
