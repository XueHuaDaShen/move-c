        ...
        // <el-form-item label="有效时间区间" required>
          <el-col :span="11">
            <el-form-item prop="effect_time1">
              <el-date-picker format="dd-MM-yyyy HH:mm:ss" type="datetime" placeholder="开始时间" v-model="ruleForm.effect_time1" style="width: 100%;"></el-date-picker>
            </el-form-item>
          </el-col>
          <el-col class="line" :span="2">-</el-col>
          <el-col :span="11">
            <el-form-item prop="effect_time2">
              <el-date-picker format="dd-MM-yyyy HH:mm:ss" type="datetime" placeholder="结束时间" v-model="ruleForm.effect_time2" style="width: 100%;"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-form-item> //
        // <el-form-item label="有效时间区间" required>
          <el-col :span="11">
            <el-form-item prop="effect_time">
              <el-date-picker format="dd-MM-yyyy HH:mm:ss" type="datetime" v-model="ruleForm.effect_time" style="width: 100%;"></el-date-picker>
            </el-form-item>
          </el-col>
        </el-form-item> //
        <el-form-item label="每笔最低存款" prop="min_recharge_every_time">
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'withdrawSet');
