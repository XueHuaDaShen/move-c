  ...
  <div class="rechargeLot-wrap el-custom">
    ...
    <div class="data-table" v-loading="loading">
      <el-table :data="daySalaryListData" header-row-class-name="table-header" stripe border style="width: 100%;font-size:12px;"
        ...
        <el-table-column align="center" prop="update_at" :formatter="formatTime" width="110" label="实发时间">
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'gameRebate');
