          ...
          <div class="rgcr-content" v-loading="loading">
            ...
            <div v-if="hasLoginname">
              ...
              <div class="tl content-row mt-30">
                <span class="exp">Add type</span>
                <span>:</span>
                <el-select clearable v-model="ruleForm.type.value" placeholder="type" class="small">
                  <el-option v-if="item.label === '人工充值-充值'" v-for="item in ruleForm.type.options" :key="item.value" :label="item.label" :value="item.value">
                  </el-option>
                </el-select>
              </div>
              <div v-show="ruleForm.type.value">
                ...
                <div class="tl content-row">
                  ...
                  <el-input type="text" v-model="ruleForm.message" placeholder="remark" style="width:300px"></el-input>
                </div>
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      let data = this.$store.state.formatMenuFn(this.index1, this.index2, 'rgcr');
