...
// const sbTxt = '近十天识别量';
export default class CjCountTime extends Component {
  constructor() {
    super();
    this.state = {
      loading: false,
  ...
  randerEcharts(type) {
    ...
    let echart = echarts.init(document.getElementById('echart-wrap-cj-time'));
    let xAxis = [], yAxis = [];
        ...
        <div className="cj-count-time">
          ...
          <div className="data-count-wrap box-shadow">
            ...
            <div className="data-wrap">
              <div className="echart-wrap" style={{display: showTable ? 'none' : 'block'}} id="echart-wrap-cj-time">
                {/* <p>{nodataText}</p>
                {nodata} */}
              </div>
