...
export default class SbSearchID extends Component {
  constructor() {
    super();
    this.state = {
      loading: false,
  ...
  handlePageChange (data) {
    ...
    this.getLogList(data.pageNum, data.pageSize);
  }
      ...
      <Loading spinning={loading} type="fence">
        <div className="cj-search-id">
          <div className="search-bar box-shadow">
            ...
            <div className="item">
              <button className="active" disabled={loading} onClick={this.search}>查询</button>
