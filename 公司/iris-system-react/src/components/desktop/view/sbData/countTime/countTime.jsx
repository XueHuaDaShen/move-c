...
import { removeLoading, appendLoading } from '../../../../loading/loading';
...
// const sbTxt = '近十天识别量';
export default class SbCountTime extends Component {
  constructor() {
    super();
    this.state = {
      loading: false,
  ...
  randerEcharts(type) {
    ...
    let echart = echarts.init(document.getElementById('echart-wrap-sb-time'));
    let xAxis = [], yAxis = [];
    for(let i=0; i<tableData.length; i++){
      xAxis.push(tableData[i].day);
        ...
        <div className="cj-count-time">
          ...
          <div className="data-count-wrap box-shadow">
            ...
            <div className="data-wrap">
              <div className="echart-wrap" style={{display: showTable ? 'none' : 'block'}} id="echart-wrap-sb-time">
                {/* <p>{nodataText}</p>
                {nodata} */}
              </div>
