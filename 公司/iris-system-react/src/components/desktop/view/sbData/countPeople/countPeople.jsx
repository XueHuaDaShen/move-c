...
// const sbTxt = '近十天识别量';
export default class SbCountPeople extends Component {
  constructor() {
    super();
    this.state = {
      loading: false,
  ...
  randerEcharts(type) {
    ...
    let echart = echarts.init(document.getElementById('echart-wrap-sb-people'));
    let xAxis = [], yAxis = [];
        ...
        <div className="cj-count-pepole">
          ...
          <div className="data-count-wrap box-shadow">
            ...
            <div className="data-wrap">
              <div className="echart-wrap" style={{display: showTable ? 'none' : 'block'}} id="echart-wrap-sb-people">
                {/* <p>{nodataText}</p>
                {nodata} */}
              </div>
