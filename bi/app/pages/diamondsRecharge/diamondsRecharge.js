...
class DiamondsRecharge extends React.Component {
    constructor() {
        super();
        this.state = {
    ...
    List() {
        ...
        Axios2(
            'get',
            '/statistic/diamondsRecharge/list',
            {
    ...
    detailList() {
        ...
        Axios2(
            'get',
            '/statistic/diamondsRecharge/detail',
            {
                begintime: this.state.startDate,
                endtime: this.state.endDate,
                pid: this.state.pid,
                ...
                render: (text, record, index) => {
                    const menu = (
                        <Menu onClick={function(e){that.onMenuClick(e,record.Method)}}>
                            ...
                            <Menu.Item key="3">Bluepay</Menu.Item>
...
export default connect(mapStateToProps, mapDispatchToProps)(DiamondsRecharge);
