...
class FishballGet extends React.Component {
    constructor() {
        super();
        this.state = {
    ...
    setChart(data) {
        ...
        // document.getElementsByClassName('xls')[0].className = 'ant-btn ant-btn-primary';
    }
    ...
    senderList() {
        ...
        Axios2(
            'get',
            '/statistic/fishball/sender/rank',
            {
                begintime: this.state.startDate,
                endtime: this.state.endDate,
                unionid: this.state.unionid,
                ...
                render: (text, record, index) => {
                    const menu = (
                        <Menu onClick={function(e){that.onMenuClick(e,record.ID)}}>
                            <Menu.Item key="1">by sender</Menu.Item>
...
export default connect(mapStateToProps, mapDispatchToProps)(FishballGet);
