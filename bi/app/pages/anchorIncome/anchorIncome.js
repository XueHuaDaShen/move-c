...
class AnchorIncome extends React.Component {
    constructor() {
        super();
        this.state = {
    ...
    setChart(data) {
        ...
        myChart.on('click', function (params) {
            that.detailList(params.dataIndex)
        });
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(AnchorIncome);
