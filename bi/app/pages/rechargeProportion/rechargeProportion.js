...
class RechargeProportion extends React.Component {
    constructor() {
        super();
        this.state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(RechargeProportion);
