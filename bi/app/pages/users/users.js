            ...
            <div className="rightView">
                <div className="salary-head">
                    <div className="content">
                        <Select size="large" defaultValue="" style={{width: 120, marginRight: 5}} onChange={this.onChangeDataType}>
                            <Option value="">All</Option>
                            <Option value="1">Sign anchor</Option>
                            <Option value="2">Not signed anchor</Option>
                        </Select>
                        <Input size="large" placeholder="pid" className="pidInput" style={{width: 120, marginRight: 5}}/>
                        <RangePicker
